                            ...
                            <div className="grid grid-cols-2 gap-8">
                                {[
                                    ...
                                    <div key={i} className="text-center">
                                        <div className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">{kpi.value}</div>
                                        <div className="text-gray-600 font-medium">{language === 'en' ? kpi.labelEn : kpi.labelZh}</div>
                                    </div>
                                ))}
                            </div>
                        </div>
