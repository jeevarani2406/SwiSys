    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name_chinese', models.CharField(blank=True, max_length=150)),
                ('last_name_chinese', models.CharField(blank=True, max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_update_logs', to=settings.AUTH_USER_MODEL)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='update_logs', to='accounts.product')),
            ],
            options={
                'ordering': ['-timestamp'],
            },
